...
require (
	...
	github.com/openshift/cluster-network-operator v0.0.0-20250303183102-972dea1fa5ac
...
require (
	...
	github.com/openshift/machine-config-operator v0.0.1-0.20231002195040-a2469941c0dc // indirect
	...
	k8s.io/kube-proxy v0.32.2 // indirect
